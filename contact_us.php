...
<div id="page-container" style="margin-top:50px; position: relative;min-height: 84vh;">
  ...
  <div id="content-wrap" style="padding-bottom:50px;">
    ...
    <div class="col-lg-4 mb-4">
        ...
        <br>
        <p>
            <h4>NAME: :</h4>ZEESHAN PEERZADA</h4>
        </p>
        <p>
            <h4>ROLL NO :</h4>AF22LHB2231
        </p>
        <p>
          <h4>  section: </h4><select name="option" id="">

<option value="">adp(cs 3 )A</option>
<option value="">adp(cs 3 )b</option>
<option value="">adp(cs 3 )c</option>
