...
<body>
  <div class="header">
    <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>><img src="image/logo1.png"> </a>
    <div class="header-right">
    <a href="about_us.php"  <?php if($active=='about') echo "class='act'"; ?> >About Us</a>
    <a href="feedback.php"  <?php if($active=='feedback') echo "class='act'"; ?> >feedback</a>
    <a href="why_donate_blood.php"  <?php if($active=='why') echo "class='act'"; ?>>Why Donate Blood</a>
      ...
      <a href="request.php" <?php if($active=='request') echo "class='act'"; ?>>request for donor</a>
    </div>
  </div>
